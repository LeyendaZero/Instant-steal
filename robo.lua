...
-- ===== LOGIN SIMPLIFICADO - Sin sistema de clave, va directo a CMD2
local function showLogin()
  local rain = startCodeRain()

  -- Abrir directamente la ventana CMD2
  ...
  -- Abrir CMD2 después de un pequeño delay
  task.delay(0.5, openCMD2)
end
...
task.delay(1.5, function()
  bigToast("Meowl Update - Steal A Brainrot", "Ready to steal")
end)

-- ===== Mobile-friendly: botón de salida flotante
if UserInputService.TouchEnabled then
  local exitBtn = Instance.new("TextButton")
  exitBtn.Size = UDim2.fromOffset(60,60)
  exitBtn.Position = UDim2.fromScale(0.02,0.92)
  ...
  applyRainbowStroke(exitBtn,1.5)
